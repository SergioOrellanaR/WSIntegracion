<%@ Page Title="" Language="C#" MasterPageFile="~/Logeado.Master" AutoEventWireup="true" CodeBehind="IndexLog.aspx.cs" Inherits="DabbawallaView.IndexLog" %>
    ...
    <div id="index-banner" class="parallax-container">
        <div class="section no-pad-bot">
            <div class="container">
                <br>
                <br>
                <h1 class="header center teal-text text-lighten-2">Bienvenido: <asp:Label ID="lblWelcome" runat="server" Text=""></asp:Label>!</h1>
