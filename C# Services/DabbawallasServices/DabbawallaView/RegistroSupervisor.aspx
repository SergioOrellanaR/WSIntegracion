<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroSupervisor.aspx.cs" Inherits="DabbawallaView.RegistroSupervisor" %>
      ...
      <ul id='dropdown1' class='dropdown-content'>
        ...
        <div id="index-banner" class="parallax-container">
            <div class="section no-pad-bot">
              <div class="container">
                <br><br>
                <h1 class="header center teal-text text-lighten-2">Registro Supervisor</h1>
                <div class="row center">
                  <h4 class="header col s12 text-lighten-2 black-text">Se parte de nuestra familia</h4>
                </div>
              </div>
            </div>
            <div class="parallax"><img src="FondoSupervisor.jpg" alt="Unsplashed background img 1"></div>
          </div>
    ...
    <!--   fin seccion login  -->
            <div class="container col s12 m4 l8">
                        <div class="row col s12">
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                                <asp:DropDownList class="form-control dropdown-trigger btn" ID="ddlZonas" runat="server">
