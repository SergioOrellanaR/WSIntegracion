...
{
    public partial class RegistroDabbawalla : System.Web.UI.Page
    {
        ...
        protected void Register(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                string registerUrl = "http://localhost:6970/dabbawallas/register/dabbawalla";

                RegisterDabbawallaRequest RegisterRequest = new RegisterDabbawallaRequest()
                {
